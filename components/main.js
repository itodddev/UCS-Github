                            ...
                            <div class="control">
                              <div class="select">
                                <select v-model="modA">
                                  ...
                                  <option value="FI6120">UCS FI 6120XP</option>
                                  <option value="FI6140">UCS FI 6140XP</option>
                                  <option value="FI6248">UCS FI 6248UP</option>
                                  <option value="FI6296">UCS FI 6296UP</option>
                                  <option value="FI6332">UCS FI 6332</option>
                                  <option value="FI6340">UCS FI 6332 16UP</option>
                                  <option value="000">-- UCS Servers --</option>
                                  <option value="C201S">UCS C200-M1 SFF</option>
                                  <option value="C201L">UCS C200-M1 LFF</option>
                                  <option value="C211S">UCS C210-M1 SFF</option>
                                  <option value="C211L">UCS C210-M1 LFF</option>
                                  <option value="C202S">UCS C200-M2 SFF</option>
                                  <option value="C202L">UCS C200-M2 LFF</option>
                                  <option value="C212S">UCS C210-M2 SFF</option>
                                  <option value="C212L">UCS C210-M2 LFF</option>
                                  <option value="C252S">UCS C250-M2 SFF</option>
                                  <option value="C262S">UCS C260-M2 SFF</option>
                                  <option value="C462S">UCS C460-M2 SFF</option>
                                  <option value="C002S">UCS C22-M3 SFF</option>
                                  <option value="C022L">UCS C22-M3 LFF</option>
                                  <option value="C024S">UCS C24-M3 SFF</option>
                                  <option value="C024L">UCS C24-M3 LFF</option>
